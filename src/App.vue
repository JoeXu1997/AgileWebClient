<template>
  <div id="app">
    <b-navbar toggleable="md" variant="dark" type="dark">
      ...
      <img src="./assets/logo.png" class="img-circle" style="padding: 5px">
      <b-navbar-brand>MyMovie</b-navbar-brand>
      <b-collapse is-nav id="nav_collapse">
        <b-navbar-nav>
          <b-nav-item to="/"><i class="fa fa-list" style="padding: 5px"> Home </i></b-nav-item>
          <b-nav-item to="/movie"><i class="fa fa-list" style="padding: 5px"> Movie </i></b-nav-item>
          <b-nav-item to="/search"><i class="fa fa-list" style="padding: 5px"> Search </i></b-nav-item>
        </b-navbar-nav>
